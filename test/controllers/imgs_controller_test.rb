...
class ImgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create img" do
    assert_difference('Img.count') do
      post imgs_url, params: { img: { alt: @img.alt, idx: @img.idx, modelname: @img.modelname, uuid: @img.uuid } }
    end
  ...
  test "should update img" do
    patch img_url(@img), params: { img: { alt: @img.alt, idx: @img.idx, modelname: @img.modelname, uuid: @img.uuid } }
